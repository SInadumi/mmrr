...
EXOPHORA_REFERENTS: list[ExophoraReferentType] = [ExophoraReferent(s) for s in ["著者", "読者", "不特定:人", "不特定:物"]]
EXOPHORA_REFERENT_TYPES: list[ExophoraReferentType] = [er.type for er in EXOPHORA_REFERENTS]
