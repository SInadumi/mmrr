...
@hydra.main(config_path="../configs/test", config_name="mmref", version_base=None)
def main(eval_cfg: DictConfig):
    ...
    model = MMRefModule.load_from_checkpoint(
    ...
    prediction_writer = MMRefWriter(clipping_threshold=eval_cfg.clipping_threshold)
